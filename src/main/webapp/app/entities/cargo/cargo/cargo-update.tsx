    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="gatewayApp.cargoCargo.home.createOrEditLabel">
              <Translate contentKey="gatewayApp.cargoCargo.home.createOrEditLabel">Create or edit a Cargo</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : cargoEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="cargo-name" type="text" name="name" />
                </AvGroup>
                <AvGroup>
                  <Label id="capacityLabel" for="capacity">
                    <Translate contentKey="gatewayApp.cargoCargo.capacity">Capacity</Translate>
                  </Label>
                  <AvField id="cargo-capacity" type="string" className="form-control" name="capacity" />
                </AvGroup>
